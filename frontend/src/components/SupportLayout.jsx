...
import { LayoutDashboard, HelpCircle, Users, Calendar, Bell, User, Settings } from 'lucide-react';
              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={`flex items-center gap-3 px-6 py-3 text-sm font-medium transition-colors ${
                    location.pathname === item.path || (location.pathname.startsWith(item.path) && item.path !== '/support/dashboard')
